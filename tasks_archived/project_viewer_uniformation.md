# Project Viewer Uniformation _(Legacy)_

> **Status:** Superseded by `client_view_unification_plan.md` (see updated consolidated plan dated 2025-09-25). Retained for historical context; do not update further.
